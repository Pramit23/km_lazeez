...
$name = $category = $price = "";
$name_err = $category_err = $price_err = "";
...
if(isset($_POST["id"]) && !empty($_POST["id"])){
    ...
    if(empty($name_err) && empty($category_err) && empty($price_err)){
        ...
        $sql = "UPDATE foodlist SET name=?, category_name=?, price=? WHERE id=?";
         
        if($stmt = mysqli_prepare($link, $sql)){
            // Bind variables to the prepared statement as parameters
            mysqli_stmt_bind_param($stmt, "sssi", $param_name, $param_cat, $param_price, $param_id);
